    ...
    <div class="card-body">
        <form method="POST" action="{{ route('indicadorplan.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" disabled="true" name="meta" id="meta" class="form-control" value=0 />
            </div>

            <div class="form-group">
                <label for="programacion_anual">Programacion Anual</label>
                <input type="number" disabled="true" name="programacion_anual" id="programacion_anual" class="form-control" value=0 required>
            </div>

            <div class="form-group">
                <label for="programadas_mes">Programacion Mensual</label>
                <input type="number" disabled="true" name="programadas_mes" id="programadas_mes" class="form-control" value=0>
            </div>
