...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" class="row" action="{{ route('indicadorplan.update', $indicadorplan->id) }}" method="POST">
            ...
            <select {{ $indicadorplan->nombre_indicador}}" class="form-control" name="nombre_indicador" id="nombre_indicador" aria-label="indicador">
            ...
            <div class="form-group col-md-6">
                ...
                <input value="{{ $indicadorplan->programacion_anual}}" type="number" name="programacion_anual" id="programacion_anual" class="form-control" value=0 required>
            </div>
