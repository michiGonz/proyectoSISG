...
<div class="container">
    <h2>Reporte Investigacion de Incidentes</h2>
    <div class="card-body">
        <form method="POST" action="{{ route('investigacion.store') }}">
            ...
            <div class="table table-primary">
                ...
                <input value="{{ $investigacion->acomulado }}" disabled="true" type="number" name="acomulado"
                    id="acomulado" class="form-control" value="0" />


                <select class="form-select p-3 m-0 border-0 bd-example m-0 border-0" name="uf" id="uf"
                    aria-label="Default select example" value="{{ $investigacion->uf}}" disabled="true">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $investigacion->nombre_incidente}}" type="text" disabled="true"
                        name="nombre_incidente" id="nombre_indcidente" class="form-control" />
                </div>

                <div class="form-group">
                    <label for="nombre_lugar">Ubicacion</label>
                    <input value="{{ $investigacion->nombre_lugar}}" disabled="true" type="ubicacion"
                        name="nombre_lugar" id="nombre_lugar" class="form-control">
                </div>
                ...
                <table class="table table-striped table-primary" disabled="true">
                    ...
                    <div class="form-check  table-primary" disabled="true">
                        <input class="form-check-input" disabled="true" type="checkbox" value="" id="flexCheckChecked"
                            checked>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $investigacion->observacion}}" disabled="true" name="observacion"
                            id="observacion" class="form-control" />
                    </div>

                    <div class="form-group">
                        <label for="date">Fecha</label>
                        <input value="{{ $investigacion->date}}" disabled="true" class="form-control" id="date"
